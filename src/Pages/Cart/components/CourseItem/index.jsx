             ...
             <div className="cartcourseimg   col-md-3">
              ...
              <div className='d-flex  justify-content-between align-items-center '>
                ...
                <Link className="" to="">Save For Later</Link>
                 ...
                 <b className='me-3 px-1 bg-warning  border  d-inline d-sm-block '>Best Seller </b>
                 <i className='me-2  '>4.7</i>
                 ...
                 <i className='text-secondary '>(87,214 ratings)</i>
                 </div>
                  <Link className="" to="">Move To Wishlist</Link>
                 </div>
                 <div className="d-flex text-secondary   ">
                
                <li className='me-4 '>6.5 total hours</li>
                  <li  className='me-4'>697 lectures</li>
...
//         <button className="btn btn-success">Updated Recently</button>
